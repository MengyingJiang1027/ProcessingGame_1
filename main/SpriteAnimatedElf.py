...
class AnimatedSpriteElf(object):
    ...
    def __init__(self, x, y, w, h, pics_folder, scr_w, scr_h, speed=3):
        ...
        #animation pics init
        kadaR1 = loadImage(pics_folder + "/elf1.png")
        kadaR2 = loadImage(pics_folder + "/elf1.png")
        kadaR3 = loadImage(pics_folder + "/elf1.png")
        kadaR4 = loadImage(pics_folder + "/elf1.png")
        # kadaR5 = loadImage(pics_folder + "/kada_R5.png")
        # kadaR6 = loadImage(pics_folder + "/kada_R6.png")

        kadaL1 = loadImage(pics_folder + "/elf1.png")
        kadaL2 = loadImage(pics_folder + "/elf1.png")
        kadaL3 = loadImage(pics_folder + "/elf1.png")
        kadaL4 = loadImage(pics_folder + "/elf1.png")
        # kadaL5 = loadImage(pics_folder + "/walking/kada_L5.png")
        # kadaL6 = loadImage(pics_folder + "/walking/kada_L6.png")

        kadaU1 = loadImage(pics_folder + "/elf1.png")
        kadaU2 = loadImage(pics_folder + "/elf1.png")
        kadaU3 = loadImage(pics_folder + "/elf1.png")
        kadaU4 = loadImage(pics_folder + "/elf1.png")

        kadaD1 = loadImage(pics_folder + "/elf1.png")
        kadaD2 = loadImage(pics_folder + "/elf1.png")
        kadaD3 = loadImage(pics_folder + "/elf1.png")
        kadaD4 = loadImage(pics_folder + "/elf1.png")

        kada_U_lose1 = loadImage(pics_folder + "/losing/elf1.png")
        kada_U_lose2 = loadImage(pics_folder + "/losing/elf1.png")
        kada_U_lose3 = loadImage(pics_folder + "/losing/elf1.png")
        kada_U_lose4 = loadImage(pics_folder + "/losing/elf1.png")

        kada_D_lose1 = loadImage(pics_folder + "/losing/elf1.png")
        kada_D_lose2 = loadImage(pics_folder + "/losing/elf1.png")
        kada_D_lose3 = loadImage(pics_folder + "/losing/elf1.png")
        kada_D_lose4 = loadImage(pics_folder + "/losing/elf1.png")

        kada_R_lose1 = loadImage(pics_folder + "/losing/elf1.png")
        kada_R_lose2 = loadImage(pics_folder + "/losing/elf1.png")
        kada_R_lose3 = loadImage(pics_folder + "/losing/elf1.png")
        kada_R_lose4 = loadImage(pics_folder + "/losing/elf1.png")

        kada_L_lose1 = loadImage(pics_folder + "/losing/elf1.png")
        kada_L_lose2 = loadImage(pics_folder + "/losing/elf1.png")
        kada_L_lose3 = loadImage(pics_folder + "/losing/elf1.png")
        kada_L_lose4 = loadImage(pics_folder + "/losing/elf1.png")
    ...
    def rectUpdate(self):
        self.area = {"top_left": {"x": self.x + 14, "y": self.y + self.h - 40},
                     "top_right": {"x": self.x + self.w - 14, "y": self.y + self.h - 40},
